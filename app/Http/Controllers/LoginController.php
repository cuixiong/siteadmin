...
class LoginController extends Controller {
    ...
    public function register(Request $request) {
        try {
            ...
            if ($model->save()) {
                ...
                ReturnJson(
                    true, trans('lang.request_success'),
                    ['token' => $token, 'status' => 1, 'expires_in' => auth('api')->factory()->getTTL() + 66240,
                     'id'    => $model->id]
                );
            } else {
    ...
    public function refresh() {
        ...
        return response()->json(
            ['code' => 200, 'message' => trans('lang.request_success'), 'data' => ['token' => $token]]
        );
    }
