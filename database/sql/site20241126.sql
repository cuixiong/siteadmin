...
ALTER TABLE `information`
    ADD COLUMN `short_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '短标题（副标题）' AFTER `title`;
...
CREATE TABLE `access_export_log` (
