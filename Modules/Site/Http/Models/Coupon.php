...
class Coupon extends Base {
    ...
    public function getIsEffectAttribute() {
        ...
        if (
            ...
            && !empty($this->attributes['time_begin'])
            && !empty($this->attributes['time_end'])
            && time() >= $this->attributes['time_begin']
            && time() <= $this->attributes['time_end']
        ) {
    ...
    public function getTypeTextAttribute() {
        ...
        if (isset($this->attributes['type'])) {
            ...
            $text = DictionaryValue::where('code', 'Coupon_Type')->where('value', $this->attributes['type'])->value(
                $field
            );
        }
