...
class SensitiveWordsLog extends Base {
    protected $table = 'sensitive_words_log';
    // 设置允许入库字段,数组形式
    protected $fillable = ['word', 'word_id', 'status', 'sort', 'product_id', 'product_name', 'product_url'];
