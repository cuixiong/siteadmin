<?php
/**
 * BlackBanList.php UTF-8
 * 黑名单模型
 *
 * @date    : 2025/1/7 14:51 下午
 *
...
class BlackBanList extends Base {
    protected $table = 'black_ban_list';
    // 设置允许入库字段,数组形式
    protected $fillable = ['id', 'ban_type', 'ban_str', 'status'];
