...
class CountryController extends CrudController
{
    ...
    {
        return Country::SaveToSite(Country::SAVE_TYPE_FULL, null, true);
    }
    ...
    protected function store(Request $request)
    {
        try {
            ...
            // 同步到分站点
            Country::SaveToSite(Country::SAVE_TYPE_SINGLE, $record->id, true);
    ...
    protected function destroy(Request $request)
    {
        try {
            ...
            // 同步到分站点
            foreach ($ids as $id) {
                Country::SaveToSite(Country::SAVE_TYPE_SINGLE, $id, true);
            }
