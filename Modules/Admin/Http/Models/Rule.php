...
{
    // 下面即是允许入库的字段，数组形式
    protected $fillable = ['parent_id','name','path','component','redirect','perm','module','controller','action','route','icon','type','sort','category','visible','keepAlive','created_by','updated_by','category'];
